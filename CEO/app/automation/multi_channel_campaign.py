...
class MultiChannelCampaignGenerator:
    ...
    async def _fetch_engagement_trends(self) -> Dict[str, Any]:
        ...
        trends_data = await self.serpapi_client.concurrent_market_research(engagement_keywords)
...
class MockTokenMonitor:
    ...
    def get_usage_summary(self, period_days: int = 1, task_type: str = None) -> Dict[str, Any]:
