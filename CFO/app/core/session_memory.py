...
class SessionMemoryManager:
    ...
    def create_session_context(
        self, user_id: str, project_name: str, initial_context: dict[str, Any] = None
    ) -> str:
...
class LegacyMemoryAdapter:
    ...
    def store(self, key: str, value: Any, category: str = "general", priority: int = 1, expires_in_days: int = None):
