        ...
        "nodes": [
            {
                ...
                "parameters": {"rule": {"hour": [9, 15, 21], "minute": 0}},
            },
            {
                "name": "Check Claude Usage",
                "type": "n8n-nodes-base.httpRequest",
                "parameters": {
                    "url": "http://localhost:8000/api/claude/usage",
                    "method": "GET",
                },
            },
            {
                ...
                "parameters": {
                    "conditions": {
                        "number": [
                            {
                                "value1": "={{$json.daily_spend}}",
                                "operation": "larger",
                                "value2": "={{$json.daily_budget * 0.8}}",
                            }
                        ]
                    }
                },
            },
            {
                ...
                "parameters": {
                    "subject": "🚨 Claude Budget Alert - 80% Used",
                    "message": "Claude daily budget is 80% utilized. Consider optimizing usage.",
                },
            },
        ],
    }
