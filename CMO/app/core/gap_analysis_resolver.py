...
from app.core.mcp_multi_agent_coordinator import MCPCoordinator, AgentType, JobPriority
...
class GapAnalysisResolver:
    ...
    async def _create_resolution_plan(self) -> Dict:
        ...
        plan_job_id = await self.mcp_coordinator.submit_job(
    ...
    async def _update_revenue_strategy(self, execution_results: Dict) -> Dict:
        ...
        strategy_job_id = await self.mcp_coordinator.submit_job(
            agent_type=AgentType.CLAUDE,
    ...
    async def _generate_week1_report(self, execution_results: Dict, updated_strategy: Dict) -> Dict:
        ...
        return {
            ...
            "revenue_impact_assessment": {
                ...
                "full_automation_ready": all(gap_status.get(gap) == "resolved" for gap in gap_status.keys()),
