    ...
    def _initialize_enterprise_plans(self) -> Dict[str, SubscriptionPlan]:
        ...
        plans = {
            ...
            "professional": SubscriptionPlan(
                ...
                price_yearly=299900,  # $2,999/year (2 months free)
                features=[
            ...
            "enterprise": SubscriptionPlan(
                plan_id="enterprise",
                name="Enterprise",
                price_monthly=119900,  # $1,199/month
                price_yearly=1199900,  # $11,999/year (2 months free)
                features=[
