...
class N8NWorkflow2Engine:
    ...
    def __init__(self):
        ...
        # Handle SerpAPI client gracefully for demo
        try:
            self.serpapi_client = get_concurrent_serpapi_client()
        except ValueError:
            logger.warning("SerpAPI not available - using mock research data")
...
""",
    ...
    async def _conduct_serpapi_research(self, session_id: str) -> Dict[str, Any]:
        ...
        if self.serpapi_client:
            ...
            logger.info("Using mock research results for demonstration")
            research_results = self._create_mock_research_results()
