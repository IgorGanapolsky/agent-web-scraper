...
# Import settings safely to avoid circular imports
...
def safe_make_record(name, level, fn, lno, msg, args, exc_info, func=None, extra=None, sinfo=None, **kwargs):
...
def setup_logging(log_level: LogLevel = None, log_to_console: bool = None) -> None:
    ...
    Args:
        ...
        log_to_console: Whether to log to console. If None, logs to console.
    """
    # Set default log level from settings if not provided
