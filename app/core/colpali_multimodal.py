...
class SaaSMarketIntelligenceMultiModal:
    ...
    async def integrate_with_existing_rag(self, index_name: str = "multimodal_intelligence"):
...
async def main():
    ...
    test_path = Path("/tmp/test_saas_document.png")
    ...
    try:
        ...
        documents = await processor.process_document(
            test_path,
            metadata={"test": True, "category": "saas_analysis"}
        )
