...
class CostTracker:
    ...
    def track_usage(self, cost: float = DEFAULT_COST_PER_CALL, **metadata) -> Dict:
...
def track_api_usage(cost: float = DEFAULT_COST_PER_CALL, **metadata) -> Dict:
...
def get_usage_summary() -> Dict:
    ...
    return {
        ...
        'average_cost_per_search': round(usage['total_cost'] / usage['total_searches'], 4) if usage['total_searches'] > 0 else 0
    }
