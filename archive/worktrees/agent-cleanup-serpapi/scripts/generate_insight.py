...
class InsightGenerator:
    def __init__(self, mode="general", target_date=None, use_cache=False):
        ...
        # SerpAPI analyzer removed during legacy cleanup
...
"""
    ...
    def generate_niche_saturation_section(self, analysis: dict[str, Any]) -> str:
        ...
        # Legacy SerpAPI analysis removed during cleanup
        section += (
            "*Legacy SerpAPI analysis removed - using alternative market research methods*\n\n"
        )
